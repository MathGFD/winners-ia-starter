...
This creates all directories and the initial `_Sistema/Wiki-LLM/wiki/index.md` and `_Sistema/Wiki-LLM/wiki/log.md` files.
...
### 3. Update _Sistema/Wiki-LLM/wiki/log.md
...
3. **How to start** — open the vault folder in Obsidian, clip an article to `_Sistema/Wiki-LLM/raw/`, then run `/second-brain-ingest`
...
1. **Clip articles** to `_Sistema/Wiki-LLM/raw/` using the Obsidian Web Clipper

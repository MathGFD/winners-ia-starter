...
Browser extension that saves web articles as clean markdown files directly into your vault's `_Sistema/Wiki-LLM/raw/` directory.

- **Install:** Chrome Web Store — https://chromewebstore.google.com/detail/obsidian-web-clipper/cnjifjpddelmedmihgijeibhnjfabmlf
- **Setup:** After installing, configure the default vault location to point to your vault's `_Sistema/Wiki-LLM/raw/` directory
...
- **When to use:** When the wiki grows beyond what `_Sistema/Wiki-LLM/wiki/index.md` can efficiently navigate (~100+ pages)

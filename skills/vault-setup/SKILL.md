...
├── 0-Inbox/          Zona de entrada — tudo novo cai aqui primeiro
├── 2-Areas/Diario/         Capturas rápidas e descargas mentais do dia
├── [pasta]/        [propósito baseado no papel do usuário]
├── [pasta]/        [propósito baseado no papel do usuário]
├── [pasta]/        [propósito baseado no papel do usuário]
├── 1-Projetos/       Trabalho ativo com status e próximas ações
└── 4-Arquivo/        Trabalho concluído — nunca deletado, só movido
...
- Dono de Negócio → `2-Areas/Pessoas/ 2-Areas/Operacoes/ 2-Areas/Decisoes/`
- Desenvolvedor → `pesquisa/ clientes/`
- Consultor → `clientes/ pesquisa/`
- Criador → `2-Areas/Conteudo/ pesquisa/ clientes/`
...
Quando pedir para escrever → ler notas recentes de 2-Areas/Diario/ para combinar com minha voz
Quando algo cair no 0-Inbox/ → perguntar se quero organizar agora
```

### Escrever arquivos de skill

**`.claude/skills/2-Areas/Diario/SKILL.md`:**
Ler a nota diária de hoje ou criar uma. Verificar 0-Inbox/ para arquivos não processados. Destacar as 3 principais prioridades. Perguntar: "No que vamos trabalhar hoje?"
...
- Criador → `.claude/skills/2-Areas/Conteudo/SKILL.md` — ler pasta de conteúdo, calibrar voz, desenvolver ideia
...
Tem arquivos para importar?
  python scripts/process_docs_to_obsidian.py ~/seus-arquivos 0-Inbox/
  Depois: "Organize tudo no 0-Inbox/ nas pastas certas"
```
